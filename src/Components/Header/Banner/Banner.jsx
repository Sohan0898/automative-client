...
const Banner = () => {
    return (
        ...
        <div className="hero min-h-[80vh]" style={{backgroundImage: 'url(https://i.ibb.co/txV99GD/blake-meyer-CRNb-Hj-Naljo-unsplash.jpg)'}}>
  ...
  >
    <span className="text text-2xl absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 transform">
     <MdOutlineMail></MdOutlineMail>
      ...
      <h1 className="mb-5 text-white text-5xl font-bold">Fusion<span className="text-FusionRed">X</span> : <br />Your Automotive Car Destination</h1>
      <p className="mb-5 text-FusionGray max-w-xl mx-auto">Discover automotive excellence at FusionX. Explore the latest innovations in electric, luxury, and high-performance cars. Elevate your driving experience today.</p>
      <button
