        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="">
            ...
            <p className="mb-5 text-gray-400 max-w-xl mx-auto">
              Discover automotive excellence at{" "}
              <span className="text-FusionRed">FusionX</span>. Explore the
              latest innovations in electric, luxury, and high-performance cars.
              Elevate your driving experience today.
            </p>

            <div className="flex flex-row-reverse justify-center gap-6 items-center  w-3/5 mx-auto mt-6">
              <Link to={"/gallery"}>
                <button
