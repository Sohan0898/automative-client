        ...
        <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
          <div className="text-center lg:flex lg:items-center lg:justify-between lg:text-left">
            <h2 className="text-4xl font-bold text-black lg:max-w-md">
              Get full Details On <span className="text-FusionRed">{brand}</span>
            </h2>
        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid items-center grid-cols-1 gap-y-8 lg:grid-cols-2 gap-x-16 xl:gap-x-24">
                  ...
                  <div className="px-10 py-6">
                    <div className="flex items-center">
                      ...
                      <p className="pl-6 text-sm font-medium text-black sm:text-lg">
                        Customer Rating on<br />
                         <span className="text-FusionBlue font-bold">{name}</span>
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-FusionBlue pt-2">Type: {type}</p>
              <p className="text-lg font-semibold text-FusionRed">Price: {price}$</p>
              <button
